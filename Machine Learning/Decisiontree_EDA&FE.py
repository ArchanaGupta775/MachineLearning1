# -*- coding: utf-8 -*-
"""
Created on Sat Jun 23 19:56:39 2018
...
tree_estimator = tree.DecisionTreeClassifier(random_state=775)
#Add parameters for tuning
#dt_grid = {'criterion':['gini','entropy'], 'max_depth':list(range(3,10)), 'min_samples_split':[2,3,6,7,8]}
dt_grid = {'criterion':['gini','entropy'], 'max_depth':list(range(5,9)), 'min_samples_split':[3,5,7,8]}
